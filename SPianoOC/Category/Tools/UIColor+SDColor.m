...
@implementation UIColor (JSDColor)
+ (instancetype)sd_colorWithHex:(uint32_t)hex {
    ...
    return [self sd_colorWithRed:r green:g blue:b];
}

+ (instancetype)sd_randomColor {
    return [UIColor sd_colorWithRed:arc4random_uniform(256) green:arc4random_uniform(256) blue:arc4random_uniform(256)];
}
